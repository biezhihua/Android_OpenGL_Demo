 ...
 * used instead.
 */
public class LessonSevenRenderer implements GLSurfaceView.Renderer, Action {
    /**
     * Used for debug logs.
     */
                ...
                for (int x = 0; x < mRequestedCubeFactor; x++) {
                    for (int y = 0; y < mRequestedCubeFactor; y++) {
                        for (int z = 0; z < mRequestedCubeFactor; z++) {
                            ...
                            final float[] thisCubePositionData = Utils.generateCubeData(p1p, p2p, p3p, p4p, p5p, p6p, p7p, p8p,
                                    p1p.length);
